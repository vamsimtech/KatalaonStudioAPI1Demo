...
WS.sendRequest(findTestObject('reqres_rest_service/ListUserRequest_Rest'))

response = WS.sendRequestAndVerify(findTestObject('reqres_rest_service/ListUserRequest_Rest'))
